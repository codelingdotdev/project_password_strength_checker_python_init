...
1. Create your own copy of this repo:
   - Follow this link: [Create repo from template](https://github.com/new?template_name=project_build_a_password_strength_checker_python_init&template_owner=codelingdotdev)
